"""Defines a scenario of ID & ASP with status quo staffing.
...
# - 10 shifts per week on Unit 22 (2 shifts each weekday)
...
# - 10 shifts per week on Unit 33 (2 shifts each weekday)
# - 5 shifts per week on Unit 34/36 (1 shift each weekday)
shift_acute_care = Shift(
    name='Acute Care',
    number=5 + 10 + 5 + 5 + 5 + 5 + 5 + 10 + 5,
    priority=3,
)
