"""Defines a scenario where teams are combined into 4 person teams.
...
# Acute Care Primary Assumptions:
# - This assumes that we prioritize at least one shift across each two
#   person team
# - 5 shifts per week on Unit 21 & 23
# - 5 shifts per week on U22 Cardio & U22 GIM
# - 5 shifts per week on Unit 24 & 26
# - 5 Shifts per week on Unit 31 & 32
# - 5 Shifts per week on Unit 33 Neuro and U33 GIM
# - 5 Shifts per week on Unit 34 and 36
shift_acute_care_primary = Shift(
    name='Acute Care Primary Coverage',
    number=5 * 6,
    priority=3,
)

# Acute Care Secondary Assumptions:
# - This is the remaining secondary coverage for each area
# - 5 shifts per week on Unit 21 & 23
# - 5 shifts per week on U22 Cardio & U22 GIM
# - 5 shifts per week on Unit 24 & 26
# - 5 Shifts per week on Unit 31 & 32
# - 5 Shifts per week on Unit 33 Neuro and U33 GIM
shift_acute_care_secondary = Shift(
    name='Acute Care Secondary Coverage',
    number=5 * 5,
    priority=4,
)
...
scenario = ScenarioDetails(
    ...
    shifts=[
        ...
        shift_ambulatory,
        shift_id_asp,
        shift_acute_care_primary,
        shift_acute_care_secondary,
    ]
)
